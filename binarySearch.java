...
class Scratch {
    public static void main(String[] args) {
        ...
        System.out.println("Your element is at : " + findElementUsingBinarySearch(array, sizeOfArray, x));
    }

    public static Integer findElementUsingBinarySearch(List<Integer> array, Integer sizeOfArray, Integer x) {
        Integer low = 0;
